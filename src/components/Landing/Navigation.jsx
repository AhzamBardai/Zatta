                  ...
                  <div className="lg:flex lg:items-center lg:justify-between">
                      <div className="flex items-center justify-between">
                          <div className="text-xl font-semibold text-gray-700">
                              <a className="text-2xl font-bold text-black dark:text-white lg:text-4xl hover:text-gray-700 dark:hover:text-gray-300 no-underline" href="/">Zatta</a>
                          </div>
                      ...
                      <div className={`mb-2 lg:flex lg:align-items-center  ${openMenu ? "block transform translate-y-6":"hidden "}`}>
                          <a href='/' className="block mx-4 mt-3 text-md text-black lg:mt-0 hover:text-gray-600 no-underline">Home</a>
                          <a href='#footer' className="block mx-4 mt-3 text-md text-black lg:mt-0 hover:text-gray-600 no-underline" >About</a>
                        { <Link to={ isLoggedIn ? "/dashboard" : '/signup'} className="no-underline">
