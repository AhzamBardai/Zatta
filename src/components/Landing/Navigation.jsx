...
function Navigation({ login }) {
    ...
    function handleClick(){
      ...
      return (
            <div>
      <nav class="bg-gray-50 shadow-sm dark:bg-gray-800">
        <div class="container px-6 py-4 mx-auto">
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="flex items-center justify-between">
                    <div class="text-xl font-semibold text-gray-700">
                        <a class="text-2xl font-bold text-black  lg:text-4xl hover:text-gray-700  no-underline" href="/">Zatta</a>
                    </div>
                    
                    <div class='flex lg:hidden '>
                        <button type="button" onClick={handleClick} class="text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400 " aria-label="toggle menu">
                ...
                <div class={`mx-4 mt-2 mb-4 lg:flex lg:align-items-center hover:text-gray-600   ${openMenu ? "block transform translate-y-6":"hidden "}`}>
                    <a href='/' class="block mx-4 mt-2 text-md text-black lg:mt-0  no-underline">Home</a>
                    <a href="#" class="block mx-4 mt-2 text-md text-black lg:mt-0  no-underline">About</a>
